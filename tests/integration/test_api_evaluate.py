...
async def test_evaluate_sync_endpoint():
    mock_result = MetricResult(metric_name="latency", score=0.9, ci_lower=0.8, ci_upper=1.0)
    with patch("openevals.core.Evaluator.evaluate_request", new_callable=AsyncMock) as mock_eval:
